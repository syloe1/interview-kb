    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-center gap-3">
          <span className="flex h-10 w-10 items-center justify-center rounded-md bg-[#edf3f9] text-[#2e5d94]">
            <Boxes size={19} strokeWidth={1.8} aria-hidden="true" />
          </span>
          <div>
            <h2 className="text-base font-semibold text-slate-900">{project.name}</h2>
            <p className="mt-0.5 font-mono text-[11px] uppercase tracking-[0.1em] text-slate-400">
              {project.category}
            </p>
          </div>
        </div>
        <ArrowUpRight
          size={18}
          className="text-slate-300 transition-colors group-hover:text-[#2e5d94]"
          aria-hidden="true"
        />
      </div>
      ...
      <div className="mt-6 flex items-center justify-between border-t border-slate-100 pt-4 text-xs text-slate-400">
        ...
        <span className="flex items-center gap-1 font-medium text-slate-500 transition-colors group-hover:text-[#2e5d94]">
