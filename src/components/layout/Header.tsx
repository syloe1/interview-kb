    ...
    <header className="sticky top-0 z-30 flex h-[68px] items-center border-b border-[var(--border)] bg-[var(--header-bg)] px-4 backdrop-blur-sm sm:px-6 lg:px-8">
      <div className="flex w-full items-center gap-3">
        <button
          ...
          onClick={onMenuClick}
          className="flex h-9 w-9 items-center justify-center rounded-md text-[var(--text-faint)] hover:bg-[var(--hover-bg)] lg:hidden"
        >
        ...
        <Link
          to="/"
          className="flex shrink-0 items-center gap-2.5 text-[15px] font-semibold tracking-[-0.01em] text-[var(--text-primary)]"
        >
        ...
        <div className="ml-auto flex min-w-0 items-center gap-3 sm:gap-5">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex h-9 items-center gap-2 rounded-md border border-[var(--border)] px-3 text-sm font-medium text-[var(--text-secondary)] transition-colors hover:border-[var(--border-active)] hover:bg-[var(--hover-bg)]"
          >
