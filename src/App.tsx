import { lazy, Suspense } from 'react'; // 懒加载 + 加载状态
    ...
    <HashRouter>
      <Routes>
        <Route element={<Layout />}>
          ...
          <Route
            path="/database/:noteId"
            element={<KnowledgeDetail category="database" />}
          />
          ...
          <Route
            path="/algorithms/:noteId"
            element={<KnowledgeDetail category="algorithms" />}
          />
          <Route path="/interview" element={<Interview />} />
          <Route
            path="/interview/:noteId"
            element={<KnowledgeDetail category="interview" />}
          />
